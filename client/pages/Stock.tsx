        ...
        <DialogContent className="max-w-lg">
          ...
          <div className="space-y-4">
            <div className="text-sm text-gray-600 bg-gray-50 p-2 rounded">
              Debug: {isSuperAdmin ? 'Super Admin' : `Ferme ID = ${user?.fermeId || 'Non défini'}`} |
              Total stocks = {stocks.length} |
              Articles disponibles = {isSuperAdmin ? stocks.length : stocks.filter(s => s.secteurId === user?.fermeId).length}
            </div>
            <div>
